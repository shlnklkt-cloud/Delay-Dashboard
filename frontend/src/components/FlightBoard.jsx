    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-orange-500 to-orange-600 text-white py-8 px-6">
        <div className="max-w-7xl mx-auto flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold">Claim Command Center</h1>
            <p className="text-orange-100 mt-1">Real-time triggers for travel insurance claims</p>
          </div>
        </div>
      </div>
        ...
        <div className="fixed bottom-6 right-6 bg-white rounded-lg shadow-2xl p-4 max-w-sm animate-in slide-in-from-bottom-5 duration-300" data-testid="whatsapp-notification">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <div className="font-semibold text-sm mb-1">Jiffy Jane</div>
              <div className="text-sm text-gray-600 mb-2">Hurray! Your claim has been successfully paid in the amount of S$100.</div>
